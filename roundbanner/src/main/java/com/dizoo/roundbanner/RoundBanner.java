...
public class RoundBanner  extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public RoundBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    public RoundBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public RoundBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public RoundBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public RoundBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public RoundBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public RoundBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public RoundBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public RoundBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public RoundBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public RoundBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public RoundBanner setImages(List<?> imageUrls) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public RoundBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public RoundBanner setOnBannerListener(OnBannerListener listener) {
